<head lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <!-- SEO Meta -->
    <meta name="description" content="MindMapku adalah aplikasi digital pembuat peta pikiran yang mendorong kemampuan berpikir kritis melalui proses merangkum dan merefleksi bacaan secara interaktif.">
    <meta name="keywords" content="MindMap, Peta Pikiran, Pendidikan, E-Learning, Critical Reading, Ringkasan Teks, Refleksi, Spider Map, Flow Map, Brace Map, Bubble Map">
    ...
    <meta property="og:description" content="Visualisasikan, ringkas, dan refleksikan bacaan secara kreatif dengan berbagai jenis peta pikiran seperti Spider Map, Flow Map, dan lainnya.">
    ...
    <meta name="twitter:description" content="MindMapku mempermudah siswa memahami bacaan dengan membuat ringkasan dan refleksi secara visual dalam bentuk peta pikiran.">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Onest:wght@100..900&family=Quicksand:wght@300..700&display=swap" rel="stylesheet">
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/mammoth/1.8.0/mammoth.browser.min.js" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
